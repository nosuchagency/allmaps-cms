            ...
            <toolbar>
                <template slot="left">
                    <div class="title-icon-wrapper">
                        <i class="fa fa-cat title-icon"></i>
                        <label>{{$t('categories.plural')}}</label>
                    </div>
                </template>
                <template slot="right">
                    <el-tooltip effect="dark"
                                :content="$t('general.actions.create', {name : $t('categories.singular')})"
                                placement="top-start"
                                v-if="$auth.user().permissions.includes('categories.create')">
            ...
            <div class="content">
                ...
                <el-table :data="tableItems"
                    ...
                    <el-table-column property="name"
                                     :label="$t('categories.attributes.name')"
                                     sortable>
                    </el-table-column>
                    <el-table-column align="right">
                        <template slot-scope="scope">
                            <el-tooltip effect="dark"
                                        :content="$t('general.actions.edit', {name : $t('categories.singular')})"
                                        placement="top-start">
                                <el-button type="primary"
                                           size="small"
...
<script>
    ...
    export default {
        ...
        computed: {
            text() {
                let name = this.selectedItems.length > 1 ? this.$t('categories.plural') : this.$t('categories.singular');
